...
// -----------------------Methods----------------------------| Start
  ...
  public void mazeDecision(){
    ...
    if (res.trim().length() == 0){
      ...
      askInstructions();
      System.out.println("\nGearing up Trial Maze 00");
      startGame("00.maze");
    }
    else if (findKeyword(res, "2") >= 0){
      System.out.println("\nGearing up Trial Maze 01");
      startGame("01.maze");
    }
    else if (findKeyword(res, "3") >= 0){
      System.out.println("\nGearing up Trial Maze 02");
      startGame("02.maze");
    }
    else if (findKeyword(res, "4") >= 0){
      System.out.println("\nGearing up Trial Maze 03");
      startGame("03.maze");
    }
  ...
  public void askInstructions(){
    ...
    if (findKeyword(res, "yes") >= 0){
      ...
      System.out.println("Pressing 'w' will go up\n");
      System.out.println("Pressing 's' will go down\n");
      System.out.println("Pressing 'd' will go left\n");
      System.out.println("Pressing 'a' will go right\n");
    }
  }
